  ...
  resources: {
    en: {
      translation: {
        ...
        LoginText:
          "API consumption application with login with google auth and firebase, using Angular Material.",
      },
    },
    es: {
      translation: {
        ...
        LoginText:
          "Aplicación de consumo de apis con login empleando google auth y firebase, usando Angular Material.",
      },
    },
  },
  lng: "en",
